...
# и так далее..`,
    ...
    [17]: {
      ...
      'Учти, что это заклинание тратит много сил, его нужно использовать только в крайнем случае, поэтому количество зарядов огненных шаров ограничено — ты можешь увидеть его в левом нижнем углу экрана.',
