...
`,
    ...
    [17]: `# подойди на одну линию с врагом
hero.move_left(5)

# запусти огненный шар вверх

# и пройди уровень дальше
`,
    [18]: `# кто-то оставил эту переменную тут\n# интересно, для чего она?\nsecret = "ИспользуйМеняСУмом"\n\n`,
...
while True:
    ...
    hero.move_right()
    `,
    [20]: `# исправь код внутри цикла, чтобы добраться
# до финиша и собрать все алмазы

while True:
    hero.move_left()
    `,
    [21]: `# подбери алмаз и избавься от волшебника
...
`,
    [22]: `# не на каждом шаге цикла будет враг
